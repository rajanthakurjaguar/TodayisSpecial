<html>
	...
	<?php
		session_start();
		echo "<font align='center'><h2>Welcome ".$_SESSION['user']." to Today is Special page Quiz Page...!</h2></font>";
	?>
	<!-- Header -->
				...
				<div class="top">
					...
					<!-- Nav -->
						<nav id="nav">
							...
							<ul>
								<li><a href="#Questions" id="history-link" class="skel-panels-ignoreHref"><span class="fa fa-th">Question</span></a></li>
								<li><a href="#SubmitLink" id="science-link" class="skel-panels-ignoreHref"><span class="fa fa-lightbulb-o">Submit</span></a></li>
							</ul>
						</nav>
